...
\begin{table}[]
	\resizebox{\textwidth}{!}{
		\begin{tabular}{l|cccc|c|c|l|l}
			...
			& & & & & & & \\
			\hline
			Multi-agent Q-Learning & \green{\cmark} & \green{\cmark} & \green{\cmark} & \green{\cmark} & \red{\xmark} & \red{\xmark} & Reinforcement Learning & Coordination proxy required \\
			RL-based Online Learning & \green{\cmark} & \green{\cmark} & \green{\cmark} & \red{\xmark} & \green{\cmark} & \red{\xmark} & Markov decision process & Reinforcement learning to solve MDP \\
			D-DASH & \green{\cmark} & \green{\cmark} & \green{\cmark} & \red{\xmark} & \green{\cmark} & \red{\xmark} & Markov decision process & Deep neural network solve MDP \\
			Pensieve & \green{\cmark} & \green{\cmark} & \green{\cmark} & \red{\xmark} & \green{\cmark} & \red{\xmark} & Policy gradient training & \begin{tabular}[c]{@{}l@{}}A3C based actor-critic network\\ Simulation based training\end{tabular} \\
			Oboe & \green{\cmark} & \green{\cmark} & \green{\cmark} & \red{\xmark} & \green{\cmark} & \red{\xmark} & Configuration tuning & \\
			PERM & \green{\cmark} & \green{\cmark} & \green{\cmark} & \red{\xmark} & \green{\cmark} & \red{\xmark} & Path selection problem & Actor-critic network with two actor network \\
			Super-resolution & \green{\cmark} & \green{\cmark} & \green{\cmark} & \red{\xmark} & \red{\xmark} & \red{\xmark} & Post download quality enhancement & Neural network based solution \\
			\hline
		\end{tabular}
	}
\end{table}
